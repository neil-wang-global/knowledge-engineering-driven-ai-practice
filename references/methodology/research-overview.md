...
《从 AI Coding 到 AI 工作系统：软件工程基本功、知识工程与 Harness Engineering 实践》60-90 分钟中文演讲稿。
...
- 包含：软件工程基本功、上下文管理、MindFlow、POMASA、知识工程、Skill、敏捷与单仓库协作、Agent 设计、提速、测试与 eval、编排方式、CLI for Agents、长时间运行、无人值守、展望。
- 排除：具体产品营销、工具入门教程、无引用的行业泛论。

## 研究立场

工程化、可验证、可落地。避免焦虑式表达。所有外部事实、案例、术语或观点必须可追溯引用。
