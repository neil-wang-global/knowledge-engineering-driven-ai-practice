---
source_url: https://github.com/eXtremeProgramming-cn/pomasa/blob/main/README.zh-cn.md
final_url: https://github.com/eXtremeProgramming-cn/pomasa/blob/main/README.zh-cn.md
title: "pomasa/README.zh-cn.md at main · eXtremeProgramming-cn/pomasa · GitHub"
status: 200
fetched_at: 2026-05-18T09:52:06.460Z
error: ""
---
...
模式目录 (skills/pomasa/pattern-catalog/)：从真实系统中提取的可重用架构模式，每个模式描述一个特定问题及其解决方案
生成器 (skills/pomasa/SKILL.md)：一个指导 AI 基于模式构建新系统的提示
架构概览
...
询问你的项目信息（或者你可以提前准备 user_input_template.md）
阅读 pattern-catalog 中的相关模式
根据你的需求选择合适的模式组合
生成完整的系统文件
场景：理解或改进现有系统
...
参见 skills/pomasa/pattern-catalog/README.md
...
对于其他运行时（Cursor、Cline、Windsurf 等）：如果你的运行时使用不同的工具名称或没有特定工具，请在你的环境中找到等效工具。模式描述的是需要什么能力，而不是使用哪个特定工具。
...
Xiong Jie. A Pattern Language for Knowledge Engineering with Large Language Models. 载于 第32届程序、人与实践模式语言大会论文集（PLoP 2025），美国华盛顿州哥伦比亚河谷 Skamania Lodge。ACM, 2026. DOI: 10.64346/PLoP2025p02 | 全文
