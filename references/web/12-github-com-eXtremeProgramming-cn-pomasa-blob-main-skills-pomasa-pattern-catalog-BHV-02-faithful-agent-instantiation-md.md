---
source_url: https://github.com/eXtremeProgramming-cn/pomasa/blob/main/skills/pomasa/pattern-catalog/BHV-02-faithful-agent-instantiation.md
final_url: https://github.com/eXtremeProgramming-cn/pomasa/blob/main/skills/pomasa/pattern-catalog/BHV-02-faithful-agent-instantiation.md
title: "pomasa/skills/pomasa/pattern-catalog/BHV-02-faithful-agent-instantiation.md at main · eXtremeProgramming-cn/pomasa · GitHub"
status: 200
fetched_at: 2026-05-18T09:52:29.450Z
error: ""
---
...
Category: Behavior Necessity: Required
...
Summarized Paraphrasing: The Orchestrator reads Agent B's Blueprint and then creates its own "summarized version" to launch the subagent. This leads to loss of critical details and execution deviations.

Task Batching: During batch execution, multiple tasks that should be independent are packaged into a single subagent invocation. This prevents each task from receiving the execution quality it deserves.
...
Caller Only Passes Parameters, Never Paraphrases Blueprint
...
Completion Criteria are Non-Negotiable
...
Related Patterns
Prompt-Defined Agent: Blueprint is the sole basis for execution
Orchestrated Agent Pipeline: Orchestrator must invoke correctly when coordinating
Parallel Instance Execution: Each instance invoked independently during parallel execution
Business-Driven Agent Design: Each Agent has a clear Blueprint
Checklist
